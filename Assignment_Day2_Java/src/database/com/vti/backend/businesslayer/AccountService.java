...
import database.com.vti.backend.datalayer.AccountRepository;
import database.com.vti.backend.datalayer.IAccountRepository;
...
public class AccountService implements IAccountService{
	...
	@Override
	public Boolean isAccNameExists(String name) throws ClassNotFoundException, SQLException, IOException {
	...
	@Override
	public boolean isAccIdExists(int id) throws ClassNotFoundException, SQLException , IOException{
